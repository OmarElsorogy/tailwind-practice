...
const CardButtons = ({ modalHandler }) => (
  <div className="flex justify-around text-white">
    <div>
      <Button
        variant="unstyled"
        className="hover:bg-hover-color-1 bg-opacity-50 p-1 rounded-lg transition-colors"
      >
        <span>
          <svg
            width="1em"
    ...
    <div>
      <Button
        ...
        variant="unstyled"
        className="hover:bg-hover-color-2 bg-opacity-50 p-1 rounded-lg transition-colors"
      >
        <span>
          <svg
            width="1em"
    ...
    <div>
      <Button
        variant="unstyled"
        className="hover:bg-hover-color-3 bg-opacity-50 p-1 rounded-lg transition-colors"
      >
        <span>
          <svg
            width="1em"
